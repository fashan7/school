    ...
    <body class="hold-transition skin-blue sidebar-mini" id="bodytag">
                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Branch Register</h3>
                                </div>
                                <form method="post" id="branchregister" role="form">
                                    <div class="box-body">
        ...
        <script>
            $(document).ready(function () {
                ...
                {
                    $.ajax({
                        url: "loadbranchDetailsToedit",
                        method: "POST",
                        success: function (jsonData)
                        {
                            $('#loadbranch').html(jsonData);
                        }
                    });
                }
                fetch_usertype();
                ...
                $('#loadbranch').editable({
                    container: 'body',
                    selector: 'td.branchname',
                    url: 'updateloadbranch',
                    title: 'Branch Name',
                    type: 'POST',
