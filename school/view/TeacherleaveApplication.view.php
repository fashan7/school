...
<html>
    <head>
        ...
        <script src="/../public/ajax/teacherleaveApplication.js"></script>
    ...
    <body class="hold-transition skin-blue sidebar-mini" id="bodytag" onload="startTime()">
                                        ...
                                        <form method="post" id="leaveAppReg" role="form">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="department" id="department" class="form-control" style="width: 100%;" value="<?= $result['depid'] ?>">   
                                                    <input type="text" name="departmentname" id="departmentname" class="form-control" style="width: 100%;" value="<?= $result['name'] ?>" readonly>                                                        
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="staffmem" id="staffmem" class="form-control" style="width: 100%;" value="<?= $result['staffid'] ?>">   
                                                    <input type="text" name="staffmemname" id="staffmemname" class="form-control" style="width: 100%;" value="<?= $result['fullname'] ?>" readonly>                                                        
                                                    <span class="help-block" id="error"></span>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group" id="leavecategorydiv">
                                                    ...
                                                    <?php
                                                    $resdep = $mat->SelectLeaveCatbyid($result['depid']);
                                                    ?>
                                                    <select name="leaveCategory" id="leaveCategory" class="form-control select2" style="width: 100%;">
                                                        ...
                                                        foreach($resdep as $row){
                                                            ...
                                                            ?><option value="<?=$row['id']?>"><?=$resultSp["name"]?></option><?php
                                                        }
                                                        ?>
                                                    </select>
                                                    <span class="help-block" id="error"></span>
        ...
        <script>
            $(document).ready(function () {
                ...
                var stafiid = $('#staffmem').val();
                var dataTable = $('#loadApplication').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "order": [],
                    "ajax": {
                        url: "getAllleaveApplicationSingle",
                        data:{id:stafiid},
                        method: "POST"
                    },
                    "columnDefs": [
