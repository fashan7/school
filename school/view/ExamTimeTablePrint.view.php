...
<html>
    ...
    ?>
                                    ...
                                    <div class="box-footer" id="hidebutton">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <a href="printExam"><button type="button" name="print" id="print" class="btn btn-warning btn-flat" >Print</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        echo "<i><b><center>All Data Are Removed  </center></b></i>";
                        ?><i><b><center><a href="examinationSchedule">Create a New TimeTable</a></center></b></i><?php
                    }
                    ?>
                </section>
            </div>
