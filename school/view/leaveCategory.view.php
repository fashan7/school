...
<html>
    <head>
        ...
        <script src="/../public/ajax/leaveCategory.js"></script>
                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form method="post" id="leaveReg" role="form">
                                                <div class="form-group">
                                                    <label for="Leave Category Name">Leave Category Name</label>
                                                    <input type="text" class="form-control" id="leaveCat" name="leaveCat" placeholder="Enter Category Name" autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <table class="table order-list">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">Category Leave Names</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="loadCatnames"></tbody>
                                            </table>
                                        </div>
                                    </div>
                                </div>
