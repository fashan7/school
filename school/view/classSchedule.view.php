...
$oneperioddur = $_GET['oneperioddur'];
$intervalperiod = $_GET['intervalperiod'];
$noofperiod = $_GET['noofperiod'];
$Intduration = $_GET['Intduration'];
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" id="bodytag">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 form-group" style="padding-top: 20px">
                                                <button type="button" class="btn btn-primary" id="createtb" name="createtb">Create Time Table</button>
                                ...
                                <!--                                    <td class="redips-mark dark">Saturday</td>-->
                                                                ...
                                                                for ($i = 1; $i <= $noofperiod; $i++) {
                                                                    if ($intervalperiod == $i) {
                                                                        ...
                                                                        $det->timetable($startperiod, $i);
                                                                    } else {
                                                                        if($intervalperiod + 1 == $i){
                                                                            $TimeDuration = date("H:i", strtotime('+' . $Intduration . ' minutes', $time));
                                                                        }
                                                                        else {
                                                                            $TimeDuration = date("H:i", strtotime('+' . $oneperioddur . ' minutes', $time));
                                                                        }                                                                        
                                                                        $det->timetable($TimeDuration, $i);
                                                                        $time = strtotime($TimeDuration);
                                                                    }
                                                                }
                                                                ?>
        ...
        <script>
            ...
            $(document).on('click', '#createtb', function () {
                var term = $('#term').val();
                var year = $('#year').val();
                var classno = $('#classno').val();
                if (term != '' && year != '' && classno != '')
                {
            ...
            $(document).ready(function () {
                ...
                $("#delete").click(function (event) {
                    ...
                    $.ajax({
                        ...
                        {
                            loading = false;
                            setTimeout("location.href = 'createTimeTable';", 0);
                        }
                    });
                });
            });
