...
<script src="https://use.fontawesome.com/releases/v5.0.6/js/fontawesome.js"></script>
  ...
  <script src="/../public/ajax/classRegister.js"></script>
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Class Register</h3>
                </div>
                <form method="post" id="classreg" role="form">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="Grade Number">Grade Number</label>
                                    <input type="text" class="form-control" id="gradenumber" name="gradenumber" placeholder="Enter Grade Number" autocomplete="off">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="gradesection" name="gradesection" placeholder="Enter Grade Section" autocomplete="off">
                                    <span class="help-block" id="error"></span>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function () {    
    ...
    {
        $.ajax({
            url: "loadGradeDetailsToedit",
            method: "POST",
            success:function(jsonData)
            {
                $('#loadGrades').html(jsonData);
            }
        });
    }
    fetch_grade();
