...
<html>
    <head>
        ...
        <script type="text/javascript" src="/../public/ajax/timeSaving.js"></script>
    ...
    <body class="hold-transition skin-blue sidebar-mini" id="bodytag">
                        ...
                        <div class="col-md-6">
                            <div class="box box-solid">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Create Time Period</h3>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="clearfix">
                                        <form method="post" id="savetimeForm" role="form" enctype="multipart/form-data">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <div class="input-group clockpicker pull-center" data-placement="left" data-align="top" data-autoclose="true">
                                                        <input type="text" class="form-control" id="time1" name="time1" type="text" placeholder="Start Time">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <div class="input-group clockpicker pull-center" data-placement="left" data-align="top" data-autoclose="true">
                                                        <input type="text" class="form-control" id="time2" name="time2" type="text" placeholder="End Time">
                                                        <span class="input-group-addon">
                                                            <span class="glyphicon glyphicon-time"></span>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-4 form-group">
                                                <div class="input-group" id="hidebutton">
                                                    <div class="input-group-btn">
                                                        <input id="add-new-event" type="submit" class="btn btn-primary btn-flat" value="Add">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <div class="box box-solid">
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="timedetails" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th>Time Period</th>
                                                    <th>Action</th>
        ...
        <script>
            var dataTable = $('#timedetails').DataTable({
                "processing": true,
                "serverSide": true,
                "order": [],
                "ajax": {
