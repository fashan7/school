...
$resultfees = $mat->destinationfeeStype($destinationid);
$month = substr("$monthOnly",0 ,2);
$year =  substr("$monthOnly",3 ,7);
?>
<script src="/../public/ajax/UpdateDestinationFeesList.js"></script>
<div class="box-header with-border">
    <h3 class="box-title">Fees Dates</h3>
</div>    
...
<div class="col-lg-4">
    <div class="form-group">
        ...
        <div class="input-group date">
            ...
            <input type="hidden" name="destinationfeestypeid<?=$i?>" id="destinationfeestypeid<?=$i?>" value="<?=$row['id']?>">
        </div>
        <span class="help-block" id="error"></span>
    </div>
</div>
