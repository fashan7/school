                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="department" id="department" class="form-control select2" style="width: 100%;">
                                                                            ...
                                                                            <?php
                                                                            $result = $mat->SelectallDepartment();
                                                        ...
                                                        <div class="user-block">
                                                            <div class="box-body">
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        <label for="Department">Department</label>
                                                                        <select name="departmentlist" id="departmentlist" class="form-control select2" style="width: 100%;">
                                                                            <option value="">-- Select Department --</option>
                                                                            <?php
                                                                            $result = $mat->SelectallDepartment();
                                                                            foreach ($result as $row) {
        ...
        <script>
            ...
            $(document).on('change', '#department', function () {
                ...
                $.ajax({
                    url: "Attendance",
                    method: "POST",
                    data: {department: department, datepicker: datepicker},
            ...
            $(document).on('change', '#month', function () {
                ...
                $.ajax({
                    ...
                    method: "POST",
                    data: {departmentlist: departmentlist, year: year, month: month},
                    success: function (jsonData)
                    {
